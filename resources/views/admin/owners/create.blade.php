                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="-m-2">
                              ...
                              <div class="p-2 w-full flex justify-around mt-4">
                                <button  onclick="location.href='{{ route('admin.owners.index') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-grey-600 rounded text-lg">戻る</button>
